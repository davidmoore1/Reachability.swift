...
import XCTest
@testable import ReachabilitySIL
...
class ReachabilityTests: XCTestCase {
    ...
    func testValidHost() {
        ...
        guard let reachability = try? ReachabilitySIL(hostname: validHostName) else {
    ...
    func testInvalidHost() {
        ...
        guard let reachability = try? ReachabilitySIL(hostname: invalidHostName) else {
            return XCTFail("Unable to create reachability")
        }
